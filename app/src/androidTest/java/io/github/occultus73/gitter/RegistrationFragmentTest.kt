...
class RegistrationFragmentTest {
    ...
    @Test
    fun testRegistrationFragment_inView() {
        val fragmentScenario = launchFragmentInContainer<RegistrationFragment>()

        onView(withId(R.id.registration)).check(matches(ViewMatchers.isDisplayed()))
    }
